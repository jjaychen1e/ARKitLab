...
[ExecuteInEditMode]
[AddComponentMenu("Camera Filter Pack/Blur/Movie2")]
public class CameraFilterPack_Blur_Movie2 : MonoBehaviour
{
    #region Variables
    ...
    void Start()
    {
        ...
        SCShader = Shader.Find("CameraFilterPack/Blur_Movie2");
